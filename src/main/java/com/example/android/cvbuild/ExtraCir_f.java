 ...
 */
public class ExtraCir_f extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = (View)inflater.inflate(R.layout.fragment_extra_cir_f, container, false);

        ArrayList<String> temp=getProfileFromFile("extraC.json",getContext());

        SpannableString t1=new SpannableString(temp.get(0));
        TextView textView = (TextView) rootView.findViewById(R.id.e1);
        ...
        TextView textView1 = (TextView) rootView.findViewById(R.id.e2);
        t2.setSpan(new StyleSpan(Typeface.BOLD), 0, t1.length(), 0);
